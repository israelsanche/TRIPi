            ...
            success: function (response) {
                ...
                if (response.businesses.length > 0) {
                    ...
                    for (i = 0; i < 10; i++) {
                        ...
                        popup.setLngLat({ lon: response.businesses[i].coordinates.longitude, lat: response.businesses[i].coordinates.latitude });
                        popup.setHTML("<p>" + response.businesses[i].name + "</p>")
                        ...
                        marker.setLngLat([response.businesses[i].coordinates.longitude, response.businesses[i].coordinates.latitude])
                        marker.addTo(map);
            ...
            success: function (response2) {
                ...
                if (response2.businesses.length > 0) {
                    ...
                    for (i = 0; i < 10; i++) {
                        ...
                        var popup = new mapboxgl.Popup({ offset: popupOffsets, className: 'my-class' })
                        popup.setLngLat({ lon: response2.businesses[i].coordinates.longitude, lat: response2.businesses[i].coordinates.latitude });
                        popup.setHTML("<p>" + response2.businesses[i].name + "</p>")
                        popup.setMaxWidth("300px")
                        // popup.addTo(map);
                        ...
                        marker.setLngLat([response2.businesses[i].coordinates.longitude, response2.businesses[i].coordinates.latitude])
                        marker.addTo(map);
                        marker.setPopup(popup);
            ...
            success: function (getFuckedUp) {
                ...
                if (getFuckedUp.businesses.length > 0) {
                    ...
                    for (i = 0; i < 10; i++) {
                        ...
                        var popup = new mapboxgl.Popup({ offset: popupOffsets, className: 'my-class' })
                        popup.setLngLat({ lon: getFuckedUp.businesses[i].coordinates.longitude, lat: getFuckedUp.businesses[i].coordinates.latitude });
                        popup.setHTML("<p>" + getFuckedUp.businesses[i].name + "</p>")
                        popup.setMaxWidth("300px")
                        // popup.addTo(map);
                        ...
                        marker.setLngLat([getFuckedUp.businesses[i].coordinates.longitude, getFuckedUp.businesses[i].coordinates.latitude])
                        marker.addTo(map);
                        marker.setPopup(popup);
